...
if rating == 2:
    emoji_holder.subheader(" We will definitely improve"+":disappointed_relieved:")
if rating == 3:
    emoji_holder.subheader(" Thanks!!"+":persevere:")
if rating == 4:
    emoji_holder.subheader(" Thanks for choosing us"+":smiley_cat:")
if rating == 5:
    emoji_holder.subheader(" Thanks for the generous rating"+":heart_eyes_cat:")
...
if submit:
    ...
    st.success("Thanks for giving your valuable feedback")
